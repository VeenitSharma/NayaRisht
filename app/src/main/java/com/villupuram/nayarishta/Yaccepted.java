...
public class Yaccepted extends AppCompatActivity {
    ...
    private static final String URL_FOR_LOGIN = "http://nayarishta.com/nayarishta-app/api/getacceptInterest.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yaccepted);
                ...
                try {
                    ...
                    for (int i = 0; i < json.length(); i++) {
                        if(i==position) {
                            ...
                            String idd  = c.getString("idrequestfrom");
                            Intent intent = new Intent(Yaccepted.this,BasicDetail.class);
        ...
        StringRequest strReq = new StringRequest(Request.Method.GET,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    JSONArray jUser = jobj.getJSONArray("acceptInterest");
                    ...
                    for (int i = 0; i < jUser.length(); i++) {
                        ...
                        String idrequestfrom = c.getString("idrequestfrom");
                        ...
                        contact.put("idrequestfrom", idrequestfrom);
    ...
    public void api(){
        ...
        final ListAdapter adapter = new SimpleAdapter(
                Yaccepted.this, inboxlist,
                R.layout.row_interest_sent, new String[]{"fromname", "idrequestfrom","createddate"}, new int[]{R.id.user_name_inbox,R.id.id_text,
                R.id.date_inbox
                });
