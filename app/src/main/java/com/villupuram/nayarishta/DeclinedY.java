...
public class DeclinedY extends AppCompatActivity {
    ...
    private static final String URL_FOR_LOGIN = "http://nayarishta.com/nayarishta-app/api/getdeclinedYouInterest.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_declined_y);
                ...
                try {
                    ...
                    for (int i = 0; i < json.length(); i++) {
                        if(i==position) {
                            ...
                            Intent intent = new Intent(DeclinedY.this,BasicDetail.class);
        ...
        StringRequest strReq = new StringRequest(Request.Method.GET,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    JSONArray jUser = jobj.getJSONArray("declinedYouInterest");
