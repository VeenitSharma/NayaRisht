...
public class YDeclined extends AppCompatActivity {
    ...
    private static final String URL_FOR_LOGIN = "http://nayarishta.com/nayarishta-app/api/getdeclineInterest.php";
    ProgressDialog progressDialog;
    public static String channel="",jsonResult="" ;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ydeclined);
                ...
                try {
                    ...
                    for (int i = 0; i < json.length(); i++) {
                        if(i==position) {
                            ...
                            Intent intent = new Intent(YDeclined.this,BasicDetail.class);
        ...
        StringRequest strReq = new StringRequest(Request.Method.GET,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    JSONArray jUser = jobj.getJSONArray("declineInterest");
    ...
    public void api(){
        ...
        final ListAdapter adapter = new SimpleAdapter(
                YDeclined.this, inboxlist,
                R.layout.row_interest_sent, new String[]{"fromname","createddate","id"}, new int[]{R.id.user_name_inbox,R.id.date_inbox,R.id.id_text}
                );
