...
public class InterestReceivedAdapter extends   RecyclerView.Adapter<InterestReceivedAdapter.ViewHolder> {

    private List<InterestReceived_ITems> listItems;
    private Context context;

    public InterestReceivedAdapter(List<InterestReceived_ITems> listItems, Context context) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        final InterestReceived_ITems listItem = listItems.get(position);
        ...
        holder.layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((InterestRecieved)v.getContext()).opendraftmsg(listItem.getId());
            }
        });
    }
