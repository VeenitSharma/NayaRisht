...
public class Sent extends AppCompatActivity {
    ...
    private static final String URL_FOR_LOGIN = "http://nayarishta.com/nayarishta-app/api/getsentPvtmsg.php";
    ...
    private void loginUser() {
        ...
        URL_FOR_DETAIL = URL_FOR_LOGIN+"?userid="+userid;
        ...
        StringRequest strReq = new StringRequest(Request.Method.GET,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    JSONArray jUser = jobj.getJSONArray("sentpvtmsg");
