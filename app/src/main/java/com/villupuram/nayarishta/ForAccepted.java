...
public class ForAccepted extends AppCompatActivity {


    private static final String TAG = "ForAccepted";
    ListView listView;
    InboxAdapter adapter;
    private static String URL_FOR_DETAIL = "";

    ArrayList<HashMap<String, String>> inboxlist;
    private static final String URL_FOR_LOGIN = "http://nayarishta.com/nayarishta-app/api/getForAcceptInterest.php";
    ProgressDialog progressDialog;
    public static String channel="",jsonResult="";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_for_accepted);
                ...
                try {
                    ...
                    for (int i = 0; i < json.length(); i++) {
                        if(i==position) {
                            ...
                            Intent intent = new Intent(ForAccepted.this,BasicDetail.class);
        ...
        StringRequest strReq = new StringRequest(Request.Method.GET,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    JSONArray jUser = jobj.getJSONArray("foracceptInterest");
